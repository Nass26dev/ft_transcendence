...
const TEAMS = {
  ...
  BAY: { n: 'Bayern', sh: 'FCB', c: '#DC052D', t: '#fff' },
...
const MATCHES = [
  {
    ...
    odds: { '1': 1.45, 'X': 4.80, '2': 6.20 }, conf: { '1': 68, 'X': 18, '2': 14 }, trend: { '1': 'up', '2': 'down' }
  },
  {
    id: 'm2', league: 'L1', home: 'OL', away: 'RCL', kickoff: 'Sam 17:00', status: 'soon',
    odds: { '1': 2.10, 'X': 3.40, '2': 3.20 }, conf: { '1': 42, 'X': 28, '2': 30 }
  },
  {
    id: 'm3', league: 'UCL', home: 'RMA', away: 'BAY', kickoff: 'Mar 21:00', status: 'soon',
    odds: { '1': 2.30, 'X': 3.50, '2': 2.85 }, conf: { '1': 48, 'X': 19, '2': 33 }, trend: { '2': 'up' }
  },
  {
    id: 'm4', league: 'L1', home: 'STADE', away: 'LOSC', kickoff: 'Dim 15:00', status: 'soon',
    odds: { '1': 2.55, 'X': 3.30, '2': 2.65 }, conf: { '1': 38, 'X': 26, '2': 36 }
  },
  {
    id: 'm5', league: 'PL', home: 'ARS', away: 'LIV', kickoff: 'Dim 17:30', status: 'soon',
    odds: { '1': 2.60, 'X': 3.40, '2': 2.55 }, conf: { '1': 40, 'X': 22, '2': 38 }, trend: { 'X': 'down' }
  },
  {
    id: 'm6', league: 'L1', home: 'ASM', away: 'RCSA', kickoff: 'Sam 19:00', status: 'soon',
    odds: { '1': 1.65, 'X': 4.00, '2': 4.80 }, conf: { '1': 60, 'X': 22, '2': 18 }
  },
];

const LIVE = [
  { id: 'lv1', league: 'PL', home: 'CHE', away: 'MUN', sh: 87, sa: 32, scoreH: 2, scoreA: 1, minute: 73, odds: { '1': 1.32, 'X': 5.50, '2': 9.00 } },
  { id: 'lv2', league: 'UCL', home: 'MCI', away: 'FCB', scoreH: 1, scoreA: 1, minute: 58, odds: { '1': 2.10, 'X': 3.10, '2': 3.50 } },
];

const MY_BETS = [
  { id: 'b1', date: 'Auj. 18:42', kind: 'Combiné x3', stake: 200, payout: 1620, odd: 8.10, status: 'pending', picks: [
  ...
  { id: 'b2', date: 'Hier 20:11', kind: 'Simple', stake: 500, payout: 925, odd: 1.85, status: 'won', picks: [
    { match: 'Lens vs Nantes', pick: 'Lens vainqueur', odd: 1.85, status: 'won' },
  ]},
  { id: 'b3', date: 'Hier 14:30', kind: 'Combiné x2', stake: 100, payout: 0, odd: 4.20, status: 'lost', picks: [
...
window.KOP_DATA = { TEAMS, LEAGUES, MATCHES, LIVE, MY_BETS, FRIENDS_FEED, LEAGUE_BOARD, CHALLENGES, TRENDING };
